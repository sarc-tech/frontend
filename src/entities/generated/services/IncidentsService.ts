...
export class IncidentsService {
   ...
   * @throws ApiError
   */
  public static updateIncidents(requestBody: Incidents): CancelablePromise<Incidents> {
   ...
   * @throws ApiError
   */
  public static addIncidents(requestBody: Incidents): CancelablePromise<Incidents> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/incidents',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static getIncidentById(incidentId: string): CancelablePromise<Incidents> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static deleteIncident(incidentId: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/incidents/{incidentId}',
      path: {
